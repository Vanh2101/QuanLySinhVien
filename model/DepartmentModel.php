...
function insertDepartment($name,$slug, $leader,$status,$logo,$beginDate){
    ...
    $sqlInsert = "INSERT INTO `department` (`name`, `slug`, `leader`, `date_beginning`, `status`,`logo`, `created_at`) VALUES (:nameDepartment, :slug, :leader, :beginDate, :statusDepartment,:logo, :createdAt)";
    $checkInsert = false;
    $db = connectionDB();
