...
//     $db = connectionDB();
//     $key = "%{$keyword}%";
//     // Adjusted SQL to optionally match department_id as well
//     $sql = "SELECT * FROM `course` 
//             WHERE (`name` LIKE :keyword OR `department_id` LIKE :keyword )
//             AND `deleted_at` IS NULL";
//     $stmt = $db->prepare($sql);
//     $data = [];
//     if ($stmt) {
//         $deptId = intval($keyword); // Convert keyword to integer, assuming department IDs are integers
...
function getAllDataCoursesByPage($keyword = null,$start = 0, $limit =10){ //$start = 0, $limit =10
    $key  = "%{$keyword}%";
